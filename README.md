...
[![Version](https://img.shields.io/badge/version-1.10.10-blue.svg)](https://github.com/baturkacamak/youtube-comment-navigator-95/releases)
...
- **Update Version:**
  ...
  just bump 1.10.10  # Direct update
  ```
...
- **Package Extension:**
  ...
  ```
  <<<<<<< HEAD
  Builds the project and creates a zip file (e.g., `youtube-comment-navigator-95_v1.10.10.zip`).
  =======
  Builds the project and creates a zip file (e.g., `youtube-comment-navigator-95_v1.10.10.zip`).
  > > > > > > > origin/main
