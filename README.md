...
[![Version](https://img.shields.io/badge/version-1.10.4-blue.svg)](https://github.com/baturkacamak/youtube-comment-navigator-95/releases)
...
- **Update Version:**
  ...
  just bump 1.10.4  # Direct update
  ```
