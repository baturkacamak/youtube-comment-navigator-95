...
const CommentList: React.FC<CommentListProps> = ({ comments }) => {
    ...
    const loadMoreComments = async () => {
        ...
        const nextComments = await db.comments
            .where('videoId')
            .equals(videoId)
            .offset(visibleCount)
            .limit(10)
    ...
    const visibleComments = groupCommentsByParent(displayedComments);
    const remainingComments = totalCommentCount - displayedComments.length;
