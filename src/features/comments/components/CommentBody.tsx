...
const CommentBody: React.FC<CommentContentProps> = React.memo(
  ({ content, handleTimestampClick }) => {
    ...
    return (
      <p
        className={`${textSize} mb-2 break-words transition-all duration-300 ease-in-out`}
        style={{ fontFamily }}
        aria-live="polite"
      >
        {highlightedText}
