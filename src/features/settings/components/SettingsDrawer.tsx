...
import {
    ...
    AdjustmentsHorizontalIcon, ArrowsPointingInIcon, ArrowsUpDownIcon, ArrowsPointingOutIcon, LanguageIcon
...
import {supportedLanguages, isLocalEnvironment} from '../../shared/utils/environmentVariables';
                ...
                <div className="bg-white dark:bg-gray-800 w-80 h-full shadow-lg p-4 flex flex-col justify-between"
                    ...
                    <div>
                        ...
                        <div id="settings-description" className="space-y-6">
                            <div className="mb-4">
                                <label
                                    className="block text-sm font-medium text-gray-800 dark:text-gray-200 mb-1">{t('Theme')}</label>
                                <SelectBox
                            ...
                            <div className="mb-4">
                                <label
                                    className="block text-sm font-medium text-gray-800 dark:text-gray-200 mb-1">{t('Text Size')}</label>
                                <SelectBox
                            ...
                            <div className="mb-4">
                                <label
                                    className="block text-sm font-medium text-gray-800 dark:text-gray-200 mb-1">{t('Language')}</label>
                                <SelectBox
